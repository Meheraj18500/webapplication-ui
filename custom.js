...
function calcHeight(value) {
  ...
  let textareaOne = document.querySelector(".textarea-box-one");
  textareaOne.addEventListener("keyup", () => {
    textareaOne.style.height = calcHeight(textareaOne.value) + "px";
  });

  let textareaTwo = document.querySelector(".textarea-box-two");
  textareaTwo.addEventListener("keyup", () => {
    textareaTwo.style.height = calcHeight(textareaTwo.value) + "px";
  });